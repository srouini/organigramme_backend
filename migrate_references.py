...
TABLE_MAPPINGS = [
    {
        'source_table': 'reference_pays',
        'target_table': 'reference_pays',
        'field_map': {'accostage': 'date_accostage', 'nom_fr_fr': 'nom_fr', 'nom_en_gb': 'nom_en'},
        'exclude_fields': ['code','alpha2','alpha3'],
    },
    {
        'source_table': 'reference_agentdouane', # Douanier model in Django
        'target_table': 'reference_douanier',
        'field_map': {'full_name': 'nom'}, # Map source 'full_name' to target 'nom'
        'exclude_fields': ['active','code'],
    },
    {
        'source_table': 'reference_type',        # TypeConteneur model in Django
        'target_table': 'reference_typeconteneur',
        'field_map': {},
        'exclude_fields': [],
    },
    {
        'source_table': 'bareme_bareme',
        'target_table': 'bareme_bareme',
        'field_map': {}, # designation maps directly, assume others too
        'exclude_fields': ['starting_date','ending_date','accostage'],
    },
    {
        'source_table': 'bareme_regime',
        'target_table': 'bareme_regime',
        'field_map': {'methode_calcule':'methode_de_calcule','parc_id':'default_parc_id','color':'couleur'}, # designation maps directly, assume others too
        'exclude_fields': ['enterposage'],
    },
    {
        'source_table': 'reference_port',
        'target_table': 'reference_port',
        'field_map': {},
        'exclude_fields': [],
    },
    {
        'source_table': 'reference_direction',
        'target_table': 'reference_direction',
        'field_map': {},
        'exclude_fields': [],
    },
    {
        'source_table': 'reference_navire',
        'target_table': 'reference_navire',
        'field_map': {},
        'exclude_fields': [],
    },
    {
        'source_table': 'reference_transitaire',
        'target_table': 'reference_transitaire',
        'field_map': {},
        'exclude_fields': [],
    },
    {
        'source_table': 'reference_consignataire',
        'target_table': 'reference_consignataire',
        'field_map': {},
        'exclude_fields': [],
    },
    {
        'source_table': 'reference_client',
        'target_table': 'reference_client',
        'field_map': {},
        'exclude_fields': [],
    },
    {
        'source_table': 'reference_parc',
        'target_table': 'reference_parc',
        'field_map': {},
        'exclude_fields': [],
    },
    {
        'source_table': 'reference_banque',
        'target_table': 'reference_banque',
        'field_map': {},
        'exclude_fields': [],
    },
    {
        'source_table': 'reference_armateur',
        'target_table': 'reference_armateur',
        'field_map': {},
        'exclude_fields': [],
    },
    {
        'source_table': 'reference_box',
        'target_table': 'reference_box',
        'field_map': {},
        'exclude_fields': [],
    }
